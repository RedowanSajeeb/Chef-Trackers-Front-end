...
//     const confirmpassword = formValue.confirmpassword.value;
    ...
    <div>
      ...
      >
        <div className="flex  flex-col items-center justify-center px-6  mx-auto md:h-screen lg:py-0">
          <div className="w-full bg-white rounded-lg shadow dark:border md:-mt-48 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
